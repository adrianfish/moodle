...
Y.namespace('M.atto_modelviewer').Button = Y.Base.create('button', Y.M.editor_atto.EditorPlugin, [], {
        ...
        _displayDialogue: function () {
            ...
            console.log("_displayDialogue");

            this._currentSelection = this.get('host').getSelection();

            console.log("calling getDialogue ...");
        ...
        _getDialogueContent: function () {
            ...
            console.log("_getDialogueContent");

            var library = this._getLibraryContent();
            var throttledUpdate = this._throttle(this._updatePreview, 500);
        ...
        _getLibraryContent: function () {
            ...
            console.log("_getLibraryContent");
            ...
            Y.Handlebars.registerHelper('split', function (delimiter, str, options) {
                ...
                var parts, current, out = '';

                if (typeof delimiter === "undefined" || typeof str === "undefined") {
                    Y.log('Handlebars split helper: String and delimiter are required.'
                            , 'debug', 'moodle-atto_equation-button');
                    return '';
                }
            ...
            var url = M.cfg.wwwroot + '/lib/editor/atto/plugins/modelviewer/ajax.php';
            var params = {
            ...
            if (preview.status === 200) { content = preview.responseText; }
